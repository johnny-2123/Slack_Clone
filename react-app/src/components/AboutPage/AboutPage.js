      ...
      <div className="about-content">
        ...
        <div className="about-metrics-container">
          <div className="about-metric">
            <img src="https://cdn-icons-png.flaticon.com/512/25/25437.png?w=826&t=st=1683679541~exp=1683680141~hmac=3857624361985a30bef0e90ccf7641ad699eea7df3d85c55f87bf07cf5134978" alt="Users Icon" className="about-metric-icon" style={{ width: "50px", height: "50px" }} />
            <p className="about-metric-text">Currently 2 million users worldwide</p>
          </div>
          <div className="about-metric">
            <img src="https://cdn-icons-png.flaticon.com/512/245/245904.png" alt="Fortune500 Icon" className="about-metric-icon" style={{ width: "50px", height: "50px" }}/>
            <p className="about-metric-text">Used by 50 of Fortune500 companies</p>
          </div>
          <div className="about-metric">
            <img src="https://icons.veryicon.com/png/o/commerce-shopping/jkd_wap/clock-137.png" alt="Timeline Icon" className="about-metric-icon" style={{ width: "50px", height: "50px" }}/>
            <p className="about-metric-text">Created site in less than a month</p>
          </div>
          <div className="about-metric">
            <img src="https://cdn-icons-png.flaticon.com/512/615/615075.png" alt="Timeline Icon" className="about-metric-icon" style={{ width: "50px", height: "50px" }}/>
            <p className="about-metric-text">Created by AJ, Ethan, and Johnny</p>
          </div>
        </div>
      </div>
      <div className="about-sidebar"></div>
