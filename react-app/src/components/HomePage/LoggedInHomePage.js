...
const LoggedInUserHomePage = ({ sessionUser }) => {
        ...
        return (
            <div key={workspace.id} className="individualWorkspaceDiv">
                <div className="individualWorkspaceLeftDiv">
                    <img
                        src={
                            "https://res.cloudinary.com/dkul3ouvi/image/upload/v1682914339/photo-1517048676732-d65bc937f952_tbpyzn.jpg"
                        }
                        alt={workspace?.name}
                    />
    ...
    return (
        <div className="homePageLoggedInMainDiv">
            ...
            {loaded && workspaces[0]?.name !== undefined && (
                <div className="workspacesMainDiv ">
                    <div className="workspaceMainDivTopDiv">
                        <h2 className="workspacesHeaderDiv">
                    ...
                    <div className="workspacesSubDiv">{workspacesArr}</div>
                </div>
            )}
            {loaded && workspaces[0]?.name === undefined && (
                <div className="workspacesMainDiv ">
                    ...
                    <div className="workspacesSubDiv noWorkspacesSubDiv">
                        {workspaces.length < 1 && (
                            <div>
                                <h2 className="notMemberOfWorkspacesHeader">
