...
export const fetchDeleteWorkspace = (workspaceId) => async (dispatch) => {
    ...
    if (response.ok) {
        ...
        console.log(
            `deleted workspace data from fetch delete Workspace:`,
            deletedWorkspace
        );
...
export const fetchUpdateWorkspace =
    (workspace, workspaceId) => async (dispatch) => {
        ...
        if (response.ok) {
            ...
            console.log(
                `updated workspace data from fetchUpdateWorkspace:`,
                updatedWorkspace
            );
...
export const fetchAddWorkspaceMember =
    (workspaceId, userEmail) => async (dispatch) => {
        ...
        if (response.ok) {
            ...
            const data = await response.json();
            console.log(
                `caught errors in fetch addWorkspace workspace member`,
                data
            );
            return data;
        }
...
export const fetchRemoveWorkspaceMember =
    (workspaceId, memberId) => async (dispatch) => {
...
const workspaces = (state = initialState, action) => {
    ...
    switch (action.type) {
        ...
        case GET_WORKSPACE_MEMBERS:
            return {
                ...state,
                currentWorkspaceMembers: [...action.payload],
            };
        case REMOVE_WORKSPACE_MEMBER:
            newState = { ...state };
            newState.currentWorkspaceMembers =
                newState.currentWorkspaceMembers.filter(
