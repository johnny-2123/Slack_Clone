...
Revision ID: 24397f43c756
Revises:
Create Date: 2023-05-15 08:48:32.151875
...
def upgrade():
    ...
    op.create_table('direct_messages',
                    ...
                    sa.Column('last_sent_message_timestamp',
    ...
    op.create_table('direct_message_members',
                    ...
                    sa.Column('direct_message_id',
                              sa.Integer(), nullable=False),
                    sa.ForeignKeyConstraint(['direct_message_id'], [
                        'direct_messages.id'], ),
                    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE direct_message_members SET SCHEMA {SCHEMA};")
